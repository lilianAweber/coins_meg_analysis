...
details.analysis.behav.sessRegKernels3 = fullfile(details.analysis.behav.folder, ...
    [details.subjName '_sessionKernels_regression_3samples.mat']);
details.analysis.behav.figSessRegKernels3 = fullfile(details.analysis.behav.folder, ...
    [details.subjName '_sessionKernels_3samples.fig']);
details.analysis.behav.sessRegKernels5 = fullfile(details.analysis.behav.folder, ...
    [details.subjName '_sessionKernels_regression_5samples.mat']);
details.analysis.behav.figSessRegKernels5 = fullfile(details.analysis.behav.folder, ...
    [details.subjName '_sessionKernels_5samples.fig']);
